<div class="section" id="usersSection">
	...
	<div class="section__buttons" id="sectionButtons">
		...
		<div class="d-flex align-items-center">
			...
			<div class="item mt-0 ml-2">
				<div class="buttons nowidth mt-0">
					<button class="nowidth mr-3" id="gameIdsSetSearch">Поиск</button>
					<button class="nowidth" id="gameIdsSetFilter7" class="ml-5">Истекает через 7 дней</button>
					<button class="nowidth" id="gameIdsSetFilter10">Истекает через 10 дней</button>
					<button class="nowidth" id="gameIdsSetFilterUnactive">Неактивные</button>
					<button class="nowidth remove" id="gameIdsResetFilter" class="remove">Сбросить</button>
				</div>
			</div>	
		</div>
	</div>
	...
	<div class="section__content" id="sectionContent">
		<div>
			...
			{#<ul class="tabstitles">
				<li id="tabNewPersonages" class="active">Заявки от пользователей</li>
				<li id="tabGamesIds">ID игр</li>
			</ul>
			
			
			<div class="tabscontent">
				<div tabid="tabNewPersonages" class="visible">
					{% if personages %}	
						<table>
							<thead>
								<tr>
						...
						<div class="d-flex align-items-center">
							<div class="item inline">
								<div class="select">
									<select gameidsfilterfield>
										<option value="pgi.game_id">ID игры</option>
										<option value="pgi.user_id">Владелец</option>
									</select>
									<div class="select__caret"></div>
								</div>
							</div>
