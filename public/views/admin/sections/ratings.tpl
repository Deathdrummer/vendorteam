...
function getUsersList() {
	$('[tabid="tabEvents"]').setWaitToBlock('Загрузка данных...');
	getAjaxHtml('admin/ratings/get_users_list', function(html) {
		$('[tabid="tabEvents"]').html(html);
		$('[tabid="tabEvents"]').setWaitToBlock(false);
		ddrInitTabs();
