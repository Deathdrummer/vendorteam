				...
				<table>
					<thead>
						<tr>
							...
							<td class="p0"></td>
							<td class="w60px" title="К исходным значениям">Опции</td>
								...
								<td class="center top pt8px">
									{% if user['wallet_balance'] != 0 %}
										<div class="buttons inline nowrap">
											<button walletalltopayout class="button pay small" title="Отправить всю сумму в оплату"><i class="fa fa-money w24px"></i></button>
											<button walletsetmaxtodeposit class="button small" title="Отправить максимально возможную сумму в резерв"><i class="fa fa-money w24px"></i></button>
											<button walletreturntoinit class="button remove small" title="Сбросить значения до начальных"><i class="fa fa-undo w24px"></i></button>
										</div>
									{% else %}
										<p class="mt10px">-</p>
									{% endif %}	
