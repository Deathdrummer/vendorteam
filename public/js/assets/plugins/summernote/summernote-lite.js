              ...
              children: [
                  ...
                  this.ui.dropdown({
                      items: (backColor ? [
                          ...
                          '    </button>',
                          '    <input type="color" id="backColorPicker'+generateCode('lLllnnnLl')+'" class="note-btn note-color-select-btn" value="#FFFF00" data-event="backColorPalette">',
                          '  </div>',
                          ...
                          (foreColor ? [
                              ...
                              this.lang.color.cpSelect,
                              '    </button>',
                              '    <input type="color" id="foreColorPicker'+generateCode('lLllnnnLl')+'" class="note-btn note-color-select-btn" value="#000000" data-event="foreColorPalette">',
